		...
		if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)
			...
			if (ndef != null) {
				try {
					...
					e.printStackTrace();
					Log.e(NFCTagmakerSettings.LOG_TAG, "IOExceptionClonenWrite");
					...
					e.printStackTrace();
					Log.e(NFCTagmakerSettings.LOG_TAG, "NullPointerCloneWrite");
					Toast.makeText(getApplicationContext(),
				...
				if (format != null) {
					try {
						...
						e.printStackTrace();
						Log.e(NFCTagmakerSettings.LOG_TAG, "IOExceptionFormat");
						Toast.makeText(getApplicationContext(),
								"IOExceptionFormat", Toast.LENGTH_SHORT).show();

					} catch (NullPointerException e) {
						e.printStackTrace();
						Log.e(NFCTagmakerSettings.LOG_TAG, "NullPointerFormat");
						Toast.makeText(getApplicationContext(),
